...
RUN apt-get update -yqq && \
    apt-get upgrade -yqq && apt-get clean
...
RUN echo "-------------------------------installed advanced"

# COPY constraints-3.8.txt /constraints-3.8.txt

RUN wget https://raw.githubusercontent.com/apache/airflow/constraints-2.0.2/constraints-3.8.txt
